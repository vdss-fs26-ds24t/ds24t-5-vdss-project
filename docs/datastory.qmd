...
fig.update_layout(
    dragmode=False,
    showlegend=False,
    xaxis=dict(showgrid=True, gridcolor="#eee8de", zeroline=False, title_font=dict(size=16)),
    yaxis=dict(showgrid=True, gridcolor="#eee8de", zeroline=False, title_font=dict(size=16)),
)
