...
<div class="visual-shell">
  <div class="moment-card">
    <div style="text-align:center; margin-bottom:24px;">
      <div style="font-size:3rem; font-weight:900; color:#E63946; line-height:1;">{max_streak} Siege am Stück</div>
      <div style="font-size:1rem; color:#202020; margin-top:4px;">{start_date} bis {end_date}</div>
